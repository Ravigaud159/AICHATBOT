...
const API_KEY = "AIzaSyDw_6OkKT3hIhhxEruTuHUFo5AXDePlgbU";
...
// generate boot response using Api

const generateBotResponse = async(incomingMessageDiv)=>{

  const messageElement = incomingMessageDiv.querySelector(".message-text")

  // add user massage to chat history 
  chatHistory.push({
    role: "user" ,
...
try{
  ...
  // reset usre file data removing indicator scroll and chat bottom
...
const handleOutGoingMessage = (e) => {
  ...
  // create and display users message
...
// haddle enter key press for sending message
...
//  intatialize emoji picker and handle emoji selection
